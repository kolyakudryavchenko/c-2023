...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void createbutton_Click(object sender, EventArgs e)
        {
            ...
            Adress add1=new Adress("Ukraine", "Kherson", "Sadova", 64);
            bool habbits=true;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            chart1.Titles.Add("Кількість студентів");
        ...
        {
            MailAddress from=new MailAddress("kolya.kudryavchenko@gmail.com");
            MailAddress to=new MailAddress("kproduction@gmail.com");
            MailMessage m=new MailMessage(from, to);
            m.Subject="C#";
            m.IsBodyHtml=true;
            m.Body="<h3>ListOfTeachers</h3>";
            m.Attachments.Add(new Attachment("C:\\Users\\user\\Desktop\\Kolya\\WindowsFormsApp2\\WindowsFormsApp2\\bin\\Debug\\ListOfTeachers.json"));
            SmtpClient smtp=new SmtpClient("smtp.gmail.com", 587);
            smtp.Credentials=new NetworkCredential("kolya.kudryavchenko@gmail.com", "gkfdgdjkfgfdoo");
            smtp.EnableSsl=true;
            smtp.Send(m);
        }
    }
